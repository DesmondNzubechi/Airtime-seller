    ...
    return(
        <div className=' bg-white mx-[20px] rounded-xl px-[10px] pt-[20px] pb-[20px]'>
           <div className='md:flex  md:flex-row sm:flex-col gap-[40px] justify-center items-center'>
            ...
            <div className='flex flex-col h-[150px] md:min-w-[170px] hover:bg-blue-300 bg-sky-500 justify-center px-[20px]  items-center shadow-xl  rounded-[10px] p-[10px]'>
            ...
            <div className='flex flex-col h-[150px] md:min-w-[170px] hover:bg-blue-300 bg-sky-500 justify-center px-[20px] items-center shadow-xl  rounded-[10px]'>
            ...
            <div className='flex flex-col h-[150px] md:min-w-[170px] hover:bg-blue-300 bg-sky-500 px-[20px] shadow-xl rounded-[10px] justify-center items-center'>
            ...
            <div className='flex flex-col h-[150px] md:min-w-[170px] hover:bg-blue-300 bg-sky-500 justify-center items-center px-[20px] shadow-xl rounded-[10px]'>
