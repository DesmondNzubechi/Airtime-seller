...
import { FAQs } from "./FAQs";
 ...
 export const FAQ = (props) => {
    ...
    return (
                ...
                <div className="border p-[10px] transition-all duration-1000 ease-in-out shadow-xl rounded-[10px] hover:bg-sky-50 cursor-pointer active:bg-sky-500" onClick={showAns}>
